...
public class FileUtils {
	...
	public static final String ROOT_DIR = "china";
	 ...
	 * @param saveName
     */
	public static void copyFromAssets(Context myContext, String ASSETS_NAME,
							String saveName) {
		String filename = getExternalStoragePath() + "/" + saveName;
		...
		try {
			if (!(new File(filename)).exists()) {
				InputStream is = myContext.getAssets()
						.open(ASSETS_NAME);
     ...
     * @return
     */
	public static String getPathFromSD(Context context, Uri uri) {
